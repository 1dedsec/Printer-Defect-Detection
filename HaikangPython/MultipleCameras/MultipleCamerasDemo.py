...
if __name__ == "__main__":
        ...
        for i in range(0, nOpenDevSuccess):
            ...
            if 0 != ret:
                tkinter.messagebox.showerror('show error',
                                             'camera:' + str(i) + ',start grabbing fail! ret = ' + To_hex_str(ret))
    ...
    def stop_grabbing():
        ...
        for i in range(0, nOpenDevSuccess):
            ...
            if 0 != ret:
                tkinter.messagebox.showerror('show error',
                                             'camera:' + str(i) + 'stop grabbing fail!ret = ' + To_hex_str(ret))
    ...
    def close_device():
        ...
        for i in range(0, nOpenDevSuccess):
            ...
            if 0 != ret:
                tkinter.messagebox.showerror('show error',
                                             'camera:' + str(i) + 'close deivce fail!ret = ' + To_hex_str(ret))
                b_is_run = True
                return
        b_is_run = False
        # 清除文本框的数值
    ...
    def set_triggermode():
        ...
        for i in range(0, nOpenDevSuccess):
            ...
            if 0 != ret:
                tkinter.messagebox.showerror('show error',
                                             'camera:' + str(i) + 'set triggersource fail!ret = ' + To_hex_str(ret))
    ...
    def trigger_once():
        ...
        for i in range(0, nOpenDevSuccess):
            ...
            if 0 != ret:
                tkinter.messagebox.showerror('show error',
                                             'camera:' + str(i) + 'set triggersoftware fail!ret = ' + To_hex_str(ret))
